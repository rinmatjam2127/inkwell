# Inkwell Design Classes — v1CS 415/515: Workshop 47
## User (entity)
- id: string
- email: string (unique)
- displayName: string
...
### Design decisions
- **Post.status uses fixed values (DRAFT, PUBLISHED), not free text.** Catches typos like "publised" early. Tradeoff: adding
